...
/*************Para informe 3 *********************
    ...
    arrayMusico[8].edad=35;
    arrayMusico[8].idInstrumento=4;
    arrayMusico[8].idOrquesta=4;
    ...
    arrayMusico[9].edad=35;
    arrayMusico[9].idInstrumento=4;
    arrayMusico[9].idOrquesta=4;
*/
...
/***********Para informe 5 ***********************
    ...
    arrayMusico[10].idInstrumento=3;
    arrayMusico[10].idOrquesta=4;
    ...
    arrayMusico[11].edad=35;
    arrayMusico[11].idInstrumento=1;
    arrayMusico[11].idOrquesta=4;


    arrayMusico[12].idMusico=14;
    arrayMusico[12].isEmpty=0;
    strcpy(arrayMusico[12].nombre,"Mus14");
    strcpy(arrayMusico[12].apellido,"AMus14");
    arrayMusico[12].edad=35;
    arrayMusico[12].idInstrumento=1;
    arrayMusico[12].idOrquesta=4;
*/
        ...
        switch(opcion)
        {
            ...
            case 10:
                utn_getUnsignedInt("\n1)Orquesta por lugar\n2)Musicos menores de 25 años\n3)Orquestas menos 6 musicos\n"
                        "4)Instrumentos de orquesta\n5)Orquestas completas\n6)Orquesta con menos musicos\n"
                        "7)Promedio instrumentos por orquesta\n8)Musicos sin instrumento de viento\nopcion:",
                        "\nError\n",1, sizeof(int), 1, 10, 1, &opcionInforme);
                switch(opcionInforme)
                {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        informe_orquestaMenosMusicos(arrayOrquesta, QTY_ARRAY_ORQUESTA, arrayMusico, QTY_ARRAY_MUSICO);
                        break;
                    case 7:
                        informe_promedioInstrumentosPorOrquesta(arrayOrquesta, QTY_ARRAY_ORQUESTA, arrayMusico, QTY_ARRAY_MUSICO);
                        break;
                    case 8:
                        informe_musicoSinInstrumentoViento(arrayMusico, QTY_ARRAY_MUSICO, arrayInstrumento, QTY_ARRAY_INSTRUMENTO);
                        break;
                    default:
                        printf("\nOpcion no valida");
                }
